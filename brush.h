...
{"null", 2, defaultBrush, no_var, (struct stateTransition[]) {
	...
	{SDLK_1, { "create/set", 4, defaultBrush, no_var, (struct stateTransition[]) {
		//0
		{SDLK_1, { "object", 7, defaultBrush, no_var, (struct stateTransition[]) {
			...
			{SDLK_7, { "weeping angel", 0, drawObject, go_weepingAngel, no_trans} },
		}}},
		//1
		...
		//2
		{SDLK_3, { "AI", 6, defaultBrush, no_var, (struct stateTransition[]) {
			...
			{SDLK_6, { "weeping angel", 0, drawAI, ai_weepingAngel, no_trans} },
		}}},
		//3
